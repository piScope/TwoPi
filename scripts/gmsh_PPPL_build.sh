...
export CMAKE_INCLUDE_PATH=${LIBPNGHOME}/include
export CMAKE_LIBRARY_PATH=${LIBPNGHOME}/lib
...
$CMAKE .. -DCMAKE_INSTALL_PREFIX=${TwoPiRoot} \
	  ...
	  -DENABLE_OS_SPECIFIC_INSTALL=0      \
          ...
          -DBLAS_LAPACK_LIBRARIES="-liomp5 -lpthread -lm -lrt" \
          -DCMAKE_C_FLAGS="-mkl=parallel"       \
          -DCMAKE_CXX_FLAGS="-mkl=parallel"     \
